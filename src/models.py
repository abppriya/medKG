...
class KGReasoning(nn.Module):
    ...
    def embed_query_box(self, queries, query_structure, idx):
        ...
        '''
        print(f"Query structure {query_structure}, queries {queries} idx {idx}")
        ...
        if all_relation_flag:
            if query_structure[0] == 'e':
                ...
                print(f"223: Query structure {query_structure}, queries {queries} idx {idx}")
                embedding, offset_embedding, idx = self.embed_query_box(queries, query_structure[0], idx)
                print(f"224: Query structure {query_structure}, queries {queries} idx {idx}")
                
            for i in range(0,len(query_structure[-1])):
                ...
                idx += 1
            print(f"236: Query structure {query_structure}, queries {queries} idx {idx}")
        else:
            embedding_list = []
